...
public abstract class Server
{
    ...
    {
        // Represends a connection with the Client => This class can be used to send data to the Client.
        // The Method processMessage(String pClientIP, int pClientPort, String pMessage); can be used to process the Message.
    ...
    // Will be called when a new Message from the client comes in.
